import { calculate } from '../challenge2';
...
describe('Challenge 2 Tests', () => {
  describe('Addition', () => {
    ...
    it('should throw an error if no numbers are provided', () => {
      expect(() => calculate({ operation: 'subtract', numbers: [] })).toThrow(
        'No numbers provided.'
      );
    });
  });
  ...
  describe('Division', () => {
    ...
    it('should throw an error if no numbers are provided', () => {
      expect(() => calculate({ operation: 'divide', numbers: [] })).toThrow(
        'No numbers provided.'
      );
    });
  });
  ...
  describe('Invalid Operation', () => {
    it('should throw an error for an invalid operation', () => {
      expect(() =>
        calculate({ operation: 'invalid', numbers: [1, 2, 3] } as any)
